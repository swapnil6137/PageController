...
open class DTPagerController: UIViewController, UIScrollViewDelegate {
    ...
    open var selectedPageIndex: Int {
        set {
            pageSegmentedControl.selectedSegmentIndex = UInt(newValue)
        ...
        get {
            ...
            return Int(pageSegmentedControl.selectedSegmentIndex < 0 ? 0 : pageSegmentedControl.selectedSegmentIndex)
        }
    }
    ...
    public init(viewControllers controllers: [UIViewController]) {
        ...
        pageSegmentedControl = DTSegmentedControl()
    ...
    open func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        if pageSegmentedControl.selectedSegmentIndex != index {
            pageSegmentedControl.selectedSegmentIndex = UInt(index)
        }
    }
